...
import com.yueshuo.scheduler.admin.core.model.XxlJobGroup;
...
import com.yueshuo.scheduler.admin.dao.XxlJobLogDao;
import com.yueshuo.scheduler.core.biz.ExecutorBiz;
import com.yueshuo.scheduler.core.biz.model.KillParam;
import com.yueshuo.scheduler.core.biz.model.LogParam;
import com.yueshuo.scheduler.core.biz.model.LogResult;
...
public class JobLogController {
	...
	@RequestMapping("/logQueryView")
	public String logQueryView(HttpServletRequest request, Model model, @RequestParam(required = false, defaultValue = "0") Integer jobId) {
		...
		return "joblog/joblog.index-dialog";
	}
	...
	public String logDetailPage(int id, Model model){
		...
		model.addAttribute("handleMod", jobLog.getHandleMod());
        model.addAttribute("logId", jobLog.getId());
		return "joblog/joblog.detail";
	}

	@RequestMapping("/logDetailPageByDag")
	public String logDetailPageByDag(int jobId,String record, Model model){
		...
		jobLog.setDagRunRecord(record);

		jobLog = xxlJobLogDao.loadByJobIdAndDagRunRecord(jobLog);

		if (jobLog == null) {

			jobLog = new XxlJobLog() ;
			jobLog.setJobId(jobId);
			//调度时间按降序排序查询一个记录，即查最新的一个记录日志
			List<XxlJobLog> logs = xxlJobLogDao.loadByJobIdLastTimeLog(jobLog);
