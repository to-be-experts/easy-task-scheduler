...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>${I18n.admin_min_name}</b></span>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "dagjob">active</#if>" ><a href="${request.contextPath}/dagjob"><i class="fa fa-circle-o text-green"></i><span>${I18n.dag_job_name}</span></a></li>
