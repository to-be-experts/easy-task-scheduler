...
public class JobServiceExample {
    private static Logger logger = LoggerFactory.getLogger(JobServiceExample.class);
    ...
    public void demoJobHandler1() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            XxlJobHelper.log("beat at:" + i);
            logger.info("demoJobHandler1 beat at:" + i) ;
    ...
    public void demoJobHandler2() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            XxlJobHelper.log("beat at:" + i);
            logger.info("demoJobHandler2 beat at:" + i) ;
            TimeUnit.SECONDS.sleep(5);
        }
    }
    ...
    public void demoJobHandler3() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            XxlJobHelper.log("beat at:" + i);
            logger.info("demoJobHandler3 beat at:" + i) ;
    ...
    public void demoJobHandler4() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            XxlJobHelper.log("beat at:" + i);
            logger.info("demoJobHandler4 beat at:" + i) ;
            TimeUnit.SECONDS.sleep(10);
        }
        // default success
    }
